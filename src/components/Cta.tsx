...
// Generated: 2025-08-22T10:47:33.319Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    { value: "100+", label: "Luxury Homes Sold", icon: Users },
    { value: "99.9%", label: "Client Satisfaction", icon: Shield },
    { value: "$500M+", label: "Total Sales Volume", icon: Zap },
    { value: "24/7", label: "Concierge Service", icon: Sparkles }
  ]
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Dream Home in Beverly Hills
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Amanda Foster Luxury Homes offers the finest selection of luxury properties
                in the heart of Beverly Hills. Let us help you find your perfect home.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Over $500 million in luxury home sales
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Exclusive Listings</h3>
              <p className="text-sm text-muted-foreground">
                Access to the most desirable properties in Beverly Hills
              </p>
            </div>
          </div>
        </div>
